...
<html lang="en">
  ...
  <head>
    ...
    <link href="<?php echo $subFolders; ?>css/logo-nav.css" rel="stylesheet">
    <link href="<?php echo $subFolders; ?>css/test.css" rel="stylesheet">
      
  <script src="<?php echo $subFolders; ?>js/load.min.js"></script>
